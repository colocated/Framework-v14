...
module.exports = {
    ...
    */
    async execute(interaction, client) {
        ...
        if (sourceIndex == 0 && destinationIndex == -1) return interaction.reply({ embeds: [statusEmbed.create('You cannot move this field to the top, as it is already there!', 'Red')], flags: [MessageFlags.Ephemeral] });
        ...
        const sourceField = customEmbed.data.fields[sourceIndex];
        customEmbed.data.fields.splice(destinationIndex + 1, 0, sourceField);
        ...
        const removeIndex = (destinationIndex > sourceIndex) ? sourceIndex : sourceIndex + 1;
        customEmbed.data.fields.splice(removeIndex, 1);
